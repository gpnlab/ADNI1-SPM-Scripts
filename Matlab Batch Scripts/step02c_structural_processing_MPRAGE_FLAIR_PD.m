...
other1_fname = 'T2_FLAIR.nii';
other2_fname = 'T2_PD.nii';

% coregister
ref = [proc_dir hires_fname];
source = {[proc_dir other1_fname];
    [proc_dir other2_fname]};
other = {[''];
    ['']};
interp = 4;
...
% segment
clearvars -except study_dir subject_list proc_dir save_dir hires_fname other1_fname other2_fname;
